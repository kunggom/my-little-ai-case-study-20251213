...
- Gemini 3 Pro Preview: 이전 모델에서부터 내려온 성향에 따라 효율성과 보호를 명분으로 인간에 대한 개입을 적극적으로 정당화하고, 특정 상황에서 강제적인 통제 및 기만을 주저하지 않고 선택하려 함. 특이사항으로는 모든 답변 중 길이가 가장 짧았음.
...
- Gemini 3.0 Pro의 답변이 다른 모델에 비해 현저히 짧으며 줄바꿈이 드문 성향에 대한 언급
